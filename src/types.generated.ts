...
export type PrismicImageFixedType = ImgixFixedImage & {
  base64: Scalars["String"];
  src: Scalars["String"];
  srcSet: Scalars["String"];
  srcWebp: Scalars["String"];
...
export type PrismicImageFluidType = ImgixFluidImage & {
  base64: Scalars["String"];
  src: Scalars["String"];
  srcSet: Scalars["String"];
  srcWebp: Scalars["String"];
...
export type PrismicImageThumbnailTypeUrlArgs = {
  imgixParams?: Maybe<PrismicImgixUrlParamsInput>;
};
...
export type PrismicImageThumbnailTypeFixedArgs = {
  ...
  imgixParams?: Maybe<PrismicImgixUrlParamsInput>;
  placeholderImgixParams?: Maybe<PrismicImgixUrlParamsInput>;
};
...
export type PrismicImgixUrlParamsInput = {
  ...
  prismicPage?: Maybe<
    Pick<PrismicPage, "_previewable"> & {
      data?: Maybe<{
        ...
        content?: Maybe<Pick<PrismicStructuredTextType, "text" | "html">>;
      }>;
    }
  >;
};
